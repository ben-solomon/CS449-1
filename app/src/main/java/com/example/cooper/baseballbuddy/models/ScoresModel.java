...
public class ScoresModel {
    ...
    private int winningPitcherID;
    private int losingPitcherID;
    private int savingPitcherID;
    private int attendance;
    private int awayTeamProbablePitcherID;
    private int homeTeamProbablePitcherID;
    private int outs;
    private int balls;
    private int strikes;
    private int currentPitcherID;
    private int currentHitterID;
    private int awayTeamStartingPitcherID;
    private int homeTeamStartingPitcherID;
    private int currentPitchingTeamID;
    private int currentHittingTeamID;
    ...
    private int rescheduledFromGameID;
    ...
    private int dueUpHitterID1;
    private int dueUpHitterID2;
    private int dueUpHitterID3;
    ...
    public int getRescheduledGameID() {
        return rescheduledGameID;
    }

    public void setRescheduledGameID(int rescheduledGameID) {
